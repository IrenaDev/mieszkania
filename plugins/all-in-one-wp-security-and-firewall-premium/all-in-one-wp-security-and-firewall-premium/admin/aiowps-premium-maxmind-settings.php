			...
			<div class="inside">
				...
				<div class="aio_blue_box">
					...
					<?php
						...
						printf(__('The key that will be used when dealing with MaxMind Geolocation services. You can read how to generate MaxMind Geolocation key from <a href="%s" target="_blank">here</a>. To create MaxMind account signup <a href="%s" target="_blank">here</a>.', 'all-in-one-wp-security-and-firewall-premium'), 'https://support.maxmind.com/hc/en-us/articles/4407111582235-Generate-a-License-Key', 'https://www.maxmind.com/en/geolite2/signup');
					?>
					</p>
				</div>
