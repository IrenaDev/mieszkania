...
class AIOWPS_CB_Settings_Menu extends AIOWPS_CB_Admin_Menu
{
	...
	/**
	 * Adding new menu tabs for country blocking.  
	 */
    public function set_menu_tabs() 
    {
        $this->menu_tabs = array(
        'tab1' => __('General Settings', 'all-in-one-wp-security-and-firewall-premium'),
        'tab2' => __('Secondary Settings', 'all-in-one-wp-security-and-firewall-premium'),
        'tab3' => __('Whitelist', 'all-in-one-wp-security-and-firewall-premium'),
        'tab4' => __('Advanced Settings', 'all-in-one-wp-security-and-firewall-premium')
        );
    }
     ...
     ?>
        ...
        <div class="inside">
			<div class="aio_blue_box">
				...
				'<br />'.__('The settings on this page are for those countries which have not been blocked sitewide. These settings allow you to select which countries will be blocked or allowed access to specific pages or posts specified in the configuration below. (You can think of this as the second line of blocking defence)', 'all-in-one-wp-security-and-firewall-premium').
			...
			<div class="aiowps_cb_yellow_box">
				<?php 
				echo __('NOTE: These settings will apply to visitors who are not blocked by the "General Settings" configuration.  If your "General Settings" configuration is disabled or no country is selected, then the "Secondary Settings" will apply to all visitors.', 'all-in-one-wp-security-and-firewall-premium');
				?>
			</div>
			<?php
			...
			<table class="form-table">
				<tr valign="top">
					...
					<span class="description"><?php _e('Check this if you want to enable the secondary country blocking feature. This will allow you to block countries based on certain posts or pages.', 'all-in-one-wp-security-and-firewall-premium'); ?></span>
					</td>
				</tr>            
			</table>
        </div></div>
        ...
        <table class="form-table">
            ...
            <tr valign="top">
                ...
                <div class="aiowps_more_info_body">
                        <?php 
                        echo '<p class="description">'.__('Example: If you sell products which ship only in your country, you could create a special page for visitors from other countries. On this page you can explain why they can\'t view your store pages.', 'all-in-one-wp-security-and-firewall-premium').'</p>';
