...
class AIOWPS_SMART_404_Settings_Menu extends AIOWPS_SMART_404_Admin_Menu
{
	...
	/**
	 * Adding new menu tabs for smart 404.  
	 */
    public function set_menu_tabs()
    {
        $this->menu_tabs = array(
            'tab1' =>  __('General Settings', 'all-in-one-wp-security-and-firewall-premium'),
            'tab2' =>  __('Blocked IPs', 'all-in-one-wp-security-and-firewall-premium'),
            'tab3' =>  __('Statistics', 'all-in-one-wp-security-and-firewall-premium')
        );
    }
    ...
    {
        echo '<div class="wrap">';
        echo '<h2>'.__('Smart 404','all-in-one-wp-security-and-firewall-premium').'</h2>';//Interface title
        $this->set_menu_tabs();
    ...
    public function render_tab2()
    {
        ...
        <div class="aio_blue_box">
            ...
            echo '<p>' . __('This tab displays the list of all permanently blocked IP addresses due to 404 events.', 'all-in-one-wp-security-and-firewall-premium') . '</p>' .
                ...
                '<p><a class="button" href="admin.php?page=' . AIOWPSEC_FIREWALL_MENU_SLUG . '&tab=tab6" target="_blank">' . __('View All 404 Events', 'all-in-one-wp-security-and-firewall-premium') . '</a></p>';
            ?>
        </div>
